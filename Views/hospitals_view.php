      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5">
          	<p class="breadcrumbs mb-0"><span class="mr-3"><a href="<?php echo base_url()?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Hospitals</span></p>
            <h1 class="mb-3 bread">Hospitals</h1>
          </div>
        </div>
      </div>
    </div>
		 ...
		 <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              ...
              <div class="text d-flex py-4">
                <div class="meta mb-3">
                  <div><a href="#"><?php echo $row->district?></a></div>
                </div>
                <div class="desc pl-3">
	                <h3 class="heading"><a href="#"><?php echo $row->hospitalname?><br><?php echo $row->address?></a></h3>
	              </div>
              </div>
            </div>
          </div>
